...
deno run --unstable --allow-net --allow-read --allow-write --allow-run --allow-env --allow-hrtime cli/tests/unit/unit_test_runner.ts

deno run --unstable --allow-all cli/tests/unit/unit_test_runner.ts