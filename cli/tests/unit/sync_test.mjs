...
unitTest({perms: {read: true, write: true}}, function fdatasyncSyncSuccess() {
...
unitTest({perms: {read: true, write: true}}, async function fdatasyncSuccess() {
...
unitTest({perms: {read: true, write: true}}, function fsyncSyncSuccess() {
...
unitTest({perms: {read: true, write: true}}, async function fsyncSuccess() {
