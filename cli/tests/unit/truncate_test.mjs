...
unitTest({perms: {read: true, write: true}}, function ftruncateSyncSuccess() {
...
unitTest({perms: {read: true, write: true}}, async function ftruncateSuccess() {
...
unitTest({perms: {read: true, write: true}}, function truncateSyncSuccess() {
...
unitTest({perms: {read: true, write: true}}, async function truncateSuccess() {
