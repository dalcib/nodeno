...
import * as datetime from "./mod.mjs";
Deno.test({
  name: "[std/datetime] parse",
  fn: () => {
    assertEquals(datetime.parse("01-03-2019 16:30", "MM-dd-yyyy HH:mm"), new Date(2019, 0, 3, 16, 30));
    assertEquals(datetime.parse("01.03.2019 16:30", "MM.dd.yyyy HH:mm"), new Date(2019, 0, 3, 16, 30));
    assertEquals(datetime.parse("01.03.2019 16:30", "MM.dd.yyyy HH:mm"), new Date(2019, 0, 3, 16, 30));
    assertEquals(datetime.parse("03-01-2019 16:31", "dd-MM-yyyy HH:mm"), new Date(2019, 0, 3, 16, 31));
    assertEquals(datetime.parse("2019-01-03 16:32", "yyyy-MM-dd HH:mm"), new Date(2019, 0, 3, 16, 32));
    assertEquals(datetime.parse("16:33 01-03-2019", "HH:mm MM-dd-yyyy"), new Date(2019, 0, 3, 16, 33));
    assertEquals(datetime.parse("01-03-2019 16:33:23.123", "MM-dd-yyyy HH:mm:ss.SSS"), new Date(2019, 0, 3, 16, 33, 23, 123));
    assertEquals(datetime.parse("01-03-2019 09:33 PM", "MM-dd-yyyy HH:mm a"), new Date(2019, 0, 3, 21, 33));
    assertEquals(datetime.parse("16:34 03-01-2019", "HH:mm dd-MM-yyyy"), new Date(2019, 0, 3, 16, 34));
    assertEquals(datetime.parse("16:35 2019-01-03", "HH:mm yyyy-MM-dd"), new Date(2019, 0, 3, 16, 35));
    assertEquals(datetime.parse("01-03-2019", "MM-dd-yyyy"), new Date(2019, 0, 3));
    assertEquals(datetime.parse("03-01-2019", "dd-MM-yyyy"), new Date(2019, 0, 3));
    assertEquals(datetime.parse("2019-01-03", "yyyy-MM-dd"), new Date(2019, 0, 3));
  }
});
Deno.test({
...
Deno.test({
  ...
  fn: () => {
    assertEquals("2019-01-01", datetime.format(new Date("2019-01-01"), "yyyy-MM-dd"));
    assertEquals("01.01.2019", datetime.format(new Date("2019-01-01"), "dd.MM.yyyy"));
    assertEquals("01:00:00", datetime.format(new Date("2019-01-01T01:00:00"), "HH:mm:ss"));
    assertEquals("13:00:00", datetime.format(new Date("2019-01-01T13:00:00"), "HH:mm:ss"));
    assertEquals("01:00:00", datetime.format(new Date("2019-01-01T01:00:00"), "hh:mm:ss"));
    assertEquals("01:00:00", datetime.format(new Date("2019-01-01T13:00:00"), "hh:mm:ss"));
    assertEquals("13:00:00.000", datetime.format(new Date("2019-01-01T13:00:00"), "HH:mm:ss.SSS"));
    assertEquals("13:00:00.000", datetime.format(new Date("2019-01-01T13:00:00.000"), "HH:mm:ss.SSS"));
    assertEquals("13:00:00.123", datetime.format(new Date("2019-01-01T13:00:00.123"), "HH:mm:ss.SSS"));
    assertEquals("01:00:00 AM", datetime.format(new Date("2019-01-01T01:00:00"), "HH:mm:ss a"));
    assertEquals("01:00:00 AM", datetime.format(new Date("2019-01-01T01:00:00"), "hh:mm:ss a"));
    assertEquals("01:00:00 PM", datetime.format(new Date("2019-01-01T13:00:00"), "hh:mm:ss a"));
    assertEquals("21:00:00 PM", datetime.format(new Date("2019-01-01T21:00:00"), "HH:mm:ss a"));
    assertEquals("09:00:00 PM", datetime.format(new Date("2019-01-01T21:00:00"), "hh:mm:ss a"));
...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(datetime.dayOfYear(new Date("-000001-01-01T00:00:00.000Z")), 1);
    assertEquals(datetime.dayOfYear(new Date("-000001-01-15T00:00:00.000Z")), 15);
    assertEquals(datetime.dayOfYear(new Date("-000001-02-01T00:00:00.000Z")), 32);
    assertEquals(datetime.dayOfYear(new Date("-000001-02-15T00:00:00.000Z")), 46);
    assertEquals(datetime.dayOfYear(new Date("-000001-03-01T00:00:00.000Z")), 60);
    assertEquals(datetime.dayOfYear(new Date("-000001-03-15T00:00:00.000Z")), 74);
    assertEquals(datetime.dayOfYear(new Date("-000001-04-01T00:00:00.000Z")), 91);
    assertEquals(datetime.dayOfYear(new Date("-000001-12-31T00:00:00.000Z")), 365);
    assertEquals(datetime.dayOfYear(new Date("-000400-01-01T00:00:00.000Z")), 1);
    assertEquals(datetime.dayOfYear(new Date("-000400-01-15T00:00:00.000Z")), 15);
    assertEquals(datetime.dayOfYear(new Date("-000400-02-01T00:00:00.000Z")), 32);
    assertEquals(datetime.dayOfYear(new Date("-000400-02-15T00:00:00.000Z")), 46);
    assertEquals(datetime.dayOfYear(new Date("-000400-03-01T00:00:00.000Z")), 61);
    assertEquals(datetime.dayOfYear(new Date("-000400-03-15T00:00:00.000Z")), 75);
    assertEquals(datetime.dayOfYear(new Date("-000400-04-01T00:00:00.000Z")), 92);
    assertEquals(datetime.dayOfYear(new Date("-000400-12-31T00:00:00.000Z")), 366);
...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(datetime.weekOfYear(new Date("2020-12-28T03:00:00.000Z")), 53);
...
Deno.test({
  ...
  fn() {
    ...
    assertEquals(difference.milliseconds, 3661e3);
