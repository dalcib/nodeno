...
`,
  ...
  {
    Name: "HugeLines",
    Input: "#ignore\n".repeat(1e4) + "@".repeat(5e3) + "," + "*".repeat(5e3),
    Output: [["@".repeat(5e3), "*".repeat(5e3)]],
    Comment: "#"
  },
  {
...
Deno.test({
  ...
  fn() {
    assertEquals(new ParseError(2, 2, null, ERR_FIELD_COUNT).message, `record on line 2: ${ERR_FIELD_COUNT}`);
