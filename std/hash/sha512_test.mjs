import {HmacSha512, Sha512} from "./sha512.mjs";
import {assertEquals} from "../testing/asserts.mjs";
import {dirname, fromFileUrl, join, resolve} from "../path/mod.mjs";
...
const methods = ["array", "arrayBuffer", "digest", "hex"];
    ...
    for (const [expected, message] of Object.entries(tests)) {
      Deno.test({
        ...
        fn() {
          ...
          const actual = method === "hex" ? algorithm[method]() : toHexString(algorithm[method]());
...
Deno.test("[hash/sha512] test Uint8Array from Reader", async () => {
  ...
  assertEquals(hash, "ee26b0dd4af7e749aa1a8ee3c10ae9923f618980772e473f8819a5d4940e0db27ac185f8a0e1d5f84f88bc887fd67b143732c304cc5fa9ad8e6f57f50028a8ff");
});
