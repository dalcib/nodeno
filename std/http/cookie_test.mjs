...
import {deleteCookie, getCookies, setCookie} from "./cookie.mjs";
...
Deno.test({
  ...
  fn() {
    ...
    assertEquals(res.headers?.get("Set-Cookie"), "deno=; Expires=Thu, 01 Jan 1970 00:00:00 GMT");
  }
});
Deno.test({
  name: "Cookie Set",
  fn() {
    ...
    assertEquals(res.headers.get("Set-Cookie"), "Space=Cat; Secure; HttpOnly; Max-Age=2; Domain=deno.land; Path=/; unparsed=keyvalue; batman=Bruce");
    res.headers = new Headers();
    setCookie(res, {
      name: "Space",
      value: "Cat",
    ...
    assertEquals(res.headers.get("Set-Cookie"), "Space=Cat; Secure; HttpOnly; Max-Age=2; Domain=deno.land; Path=/; Expires=Fri, 07 Jan 1983 15:32:00 GMT");
    res.headers = new Headers();
    ...
    assertEquals(res.headers.get("Set-Cookie"), "cookie-1=value-1; Secure, cookie-2=value-2; Max-Age=3600");
    res.headers = new Headers();
