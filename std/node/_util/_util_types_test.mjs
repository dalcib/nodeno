...
import {
  ...
  isWeakMap,
  isWeakSet
} from "./_util_types.mjs";
import * as testModuleNamespaceOpbject from "./_util_types.mjs";
...
Deno.test("Should return true for valid generator functions", () => {
  assertStrictEquals(isGeneratorFunction(function* foo() {
  }), true);
});
...
Deno.test("Should return false for invalid generation object types", () => {
  assertStrictEquals(isGeneratorObject(function* foo() {
  }), false);
});
