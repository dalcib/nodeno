...
export function parse(str, sep = "&", eq = "=", {decodeURIComponent: decodeURIComponent2 = unescape, maxKeys = 1e3} = {}) {
...
export function encodeStr(str, noEscapeTable, hexTable2) {
...
export function stringify(obj, sep = "&", eq = "=", {encodeURIComponent: encodeURIComponent2 = escape} = {}) {
  const final = [];
