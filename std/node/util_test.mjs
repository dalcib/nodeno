...
Deno.test({
  ...
  fn() {
    ...
    assert(util.isPrimitive(void 0));
...
Deno.test({
  ...
  fn() {
    assertThrows(() => util.getSystemErrorName(), TypeError);
    assertThrows(() => util.getSystemErrorName(1), RangeError);
    assertStrictEquals(util.getSystemErrorName(-424242), void 0);
